<%@ Page Language="C#" AutoEventWireup="true" CodeFile="上传课时1.aspx.cs" Inherits="上传课时1" %>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                                    <div class="card-title">
                                        <div class="title">
                                        	<font style="font-size:x-large;margin-top:20px;">课时信息</font> 
                                        </div>                                     
                                    </div>
                                     <p style="font-family: '微软雅黑';font-size:medium;">请您完善该课时相关信息,并上传该课时相关资料</p>
                                </div>
                <div class="panel-body"> 
                    <div class="sub-title" style="font-size:medium;">课时<span style="font-size:smaller;">（例如：第一课时，输入“1”）</span></div>
                                    <div>
                                        <input type="text" class="form-control" id="UnitRank" runat="server"/>
                                    </div>
                    <div class="sub-title" style="font-size:medium;">课时名称</div>
                                    <div>
                                        <input type="text" class="form-control" id="UnitName" runat="server"/>
                                    </div>
                    <div style="margin-top: 20px;">
                        ...
                        <div>
                            ...
                            <label style="margin-top:15px;font-size:medium;">PPT/WORD/PDF资料<span style="font-size:smaller;">(若没有此类型资料请单击下一步)</span></label>
                            <div class="upload" style="width:800px;">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <div id="status" class="info">请选择要上传的PPT/WORD/PDF文件，其他类型资料请单击“只添加课时，不添加文件”</div>
                                        <div class="commands" style="margin-right:200px;">                 
                ...
                <div style="margin-top: 20px;margin-bottom: 20px;">  
                                          <center>
                                              <asp:Button ID="Button1" class="btn btn-info btn-lg" OnClick="upload_Click" runat="server" Text="课时和文件同时添加" /> 
                                              <asp:Button ID="Button2" class="btn btn-info btn-lg" Onclick="Button2_Click" runat="server" Text="只添加课时，不添加文件" />
                                        </center>
               </div>                          </div>
            </div>           
