<%@ Page Language="C#" AutoEventWireup="true" CodeFile="编辑课时.aspx.cs" Inherits="编辑课时" %>
...
<body style="background-color: #EDEDED;font-family: '微软雅黑';">
    ...
    <script type="text/javascript">
        ...
        <div class="header" style="margin-top: 40px;background-color:white;height: 41px;">
		  	<div style="margin-left: 20px;">
               <a href="UnitList.aspx"><img src="assets/img/后退CoGraphics.png" style="height:30px;width:30px;"/></a> 
             <font style="font-size:x-large;margin-left:20px;">  
                 <strong>您正在编辑第<%=unitrank%>课时</font>
		  	</div>											
		</div>
        ...
        <div id="page-inner">
            <div class="panel panel-default">
                <div class="panel-body"> 
                    <div class="sub-title" style="font-size:medium;">课时：<%=unitrank %></div>
                    
                    <div class="sub-title" style="font-size:medium;">课时名称：<%=unitname %></div> 
                    <div>
                        <input type="text" class="form-control" id="Name" runat="server" placeholder="请将新课时名称写在这里" onchange="IFhasfile()"/>
                    </div>
                    <div class="sub-title" style="font-size:medium;">已有文件列表：</div>
                    <div>   
                    <div>
                        <img src="assets/img/文件.png" style="width:15px;height:15px;"/>
                        <span>PPT.WORD.PDF：<%=FileName1 %>
                        </span><br/>
                    </div>
                        <div>
                            <img src="assets/img/文件.png" style="width:15px;height:15px;"/>
                            <span>视频：<%=FileName2 %></span><br/>
                        </div>
                        <div>
                            <img src="assets/img/文件.png" style="width:15px;height:15px;"/>
                            <span>音频：<%=FileName3 %></span><br/>
                        </div>                       
                    </div> 
                    <%-- 当文件数等于3时，隐藏该样式 --%>        
                    <div style="margin-top: 50px;" id="div1" runat="server">
                        <div style="height:25px;"></div>
                        <label for="exampleInputFile" style="font-size:medium;">您可以继续上传课时资料
                            <span style="font-size:smaller;">（不可上传与已存在文件同类型资料）</span>
                        </label>
                        <div>

                             <%--<label style="margin-top:15px;font-size:medium;">视频资料<span style="font-size:smaller;">(若没有此类型资料请单击下一步)</span></label>--%>
                ...
                <div style="margin-top: 20px;margin-bottom: 20px;">  
                                          <center>
                                              <asp:Button ID="Button1" class="btn btn-info btn-lg" OnClick="upload_Click" runat="server" Text="保存" /> 
                                        </center>
               </div>                          </div>
            </div>
    ...
    <script language="JavaScript">
        function IFhasfile() {
            document.getElementById('IFhasFile').value = "1";
        }
</script>
</body>
</html>