<%@ Page Language="C#" AutoEventWireup="true" CodeFile="上传课时2.aspx.cs" Inherits="上传课时2" %>
    ...
    <script type="text/javascript">
        ...
        <div class="header" style="margin-top: 40px;background-color:white;height: 41px;">
             ...
             <font style="font-size:x-large;margin-left:20px;">  
                 <strong>您正在为第<%=URank %>课时添加视频资料</strong></font>
		  	</div>											
		</div>
        ...
        <div id="page-inner">
            <div class="panel panel-default">
                        ...
                        <div>
                            ...
                            <div class="upload" style="width:800px;">
                                ...
                                <div>
                                    ...
                                    <div>
                                       <%-- <div id="status" class="info">请选择要上传的文件,文件包括视频(仅支持MP4格式)、音频、PPT和Word.</div>--%>
                                        <div id="status" class="info">请选择要上传的MP4格式的视频文件，其他类型资料请单击下一步</div>
                                        <div class="commands" style="margin-right:300px;">                 
                ...
                <div style="margin-top: 20px;margin-bottom: 20px;">  
                                          <center>
                                              <asp:Button ID="Button1" class="btn btn-info btn-lg" OnClick="upload_Click" runat="server" Text="下一步" /> 
                                              <label style="margin-left:20px;"><a href="上传课时3.aspx">跳过</a></label> 
                                        </center>
               </div>                          </div>
            </div>
