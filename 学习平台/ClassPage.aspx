...
<body style="background-color:#f6f6f6" > 
    ...
    <form id="form1" runat="server">
        <div class="container hidden-xs"  style="padding-top: 20px; background-color: white;">
        ...
        <p class="container" style="padding: 15px 15px 15px 15px">共有<%=ClassNum %>门相关的课程</p>

        <div class="container breadcrumb" style="background-color: white;">

            <span>全部课程</span>
            <div class="btn-group" style="float: right">
                <asp:button ID="Button1" runat="server" OnClick="Zonghe_Click" class="btn btn-default" Text="综合"></asp:button>
                <asp:button ID="Button2" runat="server" OnClick="Zuire_Click" class="btn btn-default" Text="最热"></asp:button>
                <div class="btn-group">
			...
			<span class="caret"></span>
                    ...
                    <ul class="dropdown-menu" style="min-width:70px">
                        <li><asp:button ID="Button3" runat="server" OnClick="Quanbu_Click" class="btn btn-default" BorderStyle="None" Width="100%" Text="全部"></asp:button></li>
                        <li><asp:button ID="Button4" runat="server" OnClick="Mianfei_Click" class="btn btn-default" BorderStyle="None" Width="100%" Text="免费"></asp:button></li>
                        <li><asp:button ID="Button5" runat="server" OnClick="Fufei_Click" class="btn btn-default" BorderStyle="None" Width="100%" Text="付费"></asp:button></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container" style="background-color: white;">
            <asp:DataList ID="datalist2" runat="server" RepeatColumns="2" RepeatDirection="Horizontal">
                <ItemTemplate>
                    <div class="hidden-lg hidden-md hidden-sm col-xs-6" style="margin-top: 10px;height :130px">

                        <img src="img/picture4.jpg" style="width: 110px; height: 75px" />
                        
                        <div style="font-size: 12px;font-family: '微软雅黑';width:110px">
                           <a href="VideoPage.aspx?classid=<%#Eval("ClassID") %>"> <p style="width: 110px;"><%# Eval("ClassName") %></p></a>
                            <span style="color: red;">￥<%# Eval("ClassPrice") %></span>
                            <span style="color: #808080;font-size:12px;float:right;"><%# Eval("ClassCollectionNum") %>人收藏</span>
                        </div>
                    </div>
                </ItemTemplate>
            </asp:DataList>
